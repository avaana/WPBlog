<?php
	...
	Kirki::add_field( 'heart_and_style', array(
		'type'        => 'select',
		'settings'    => $prepend . 'popular_post_date_state',
		'label'       => __( 'Enable/Disable', 'heart-and-style' ),
		'section'     => 'heart_and_style_section_popular_date',
		'default'     => 'enabled',
		'choices'     => array(
	...
	Kirki::add_field( 'heart_and_style', array(
		'type'        => 'typography',
		'settings'    => $prepend . 'popular_post_date_typography',
		...
		'output' => array(
			array(
				'element' => '#footer-posts .blog-post-alt-meta',
			),
		),
	) );
	...
	Kirki::add_field( 'heart_and_style', array(
		'type'        => 'spacing',
		'settings'    => $prepend . 'popular_post_date_spacing',
	...
	Kirki::add_field( 'heart_and_style', array(
		'type'        => 'color',
		'settings'    => $prepend . 'popular_post_date_color',
