...
add_action( 'widgets_init', create_function( '', 'register_widget( "heart_and_style_instagram_widget" );' ) );
class Heart_And_Style_Instagram_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'heart_and_style_instagram_widget', // Base ID
	...
	public function widget( $args, $instance ) {
		...
		$transient_id = 'heart_and_style_instagram_transient_' . $username;
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php _e( 'User ID:', 'heart-and-style' ); ?></label> 
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'username' ) ); ?>" type="text" value="<?php echo esc_attr( $username ); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'access_token' ) ); ?>"><?php _e( 'Access Token:', 'heart-and-style' ); ?> ( can be found <a href="http://instagram.pixelunion.net" target="_blank">here</a> )</label> 
