<?php
/**
 * Template Name: Home - 3 Col Full Width
 */
?>
	...
	<div id="content">
		...
		<?php 
			...
			if ( $heart_and_style_query->have_posts() ) :
				...
				?><div class="blog-posts-listing blog-posts-listing-3-col-full-width"><?php
					...
					?><div class="blog-posts-listing-inner clearfix"><?php
						...
						while ( $heart_and_style_query->have_posts() ) : $heart_and_style_query->the_post(); $count++; $real_count++;
							...
							get_template_part( 'template-parts/content-3-col', get_post_format() );
