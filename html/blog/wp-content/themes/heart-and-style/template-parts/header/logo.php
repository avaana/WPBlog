...
?>
	<div id="logo" class="<?php echo esc_attr( $logo_class ); ?>">
		<?php if ( $logo_position == 'below_center' ) : ?><div class="wrapper"><?php endif; ?>
			<a href="<?php echo esc_url( 'https://avaana.com.au' ); ?>" rel="home"><img class="<?php echo esc_attr( $logo_img_class );?>" src="<?php echo esc_attr( $logo_img_src ); ?>" data-retina-ver="<?php echo esc_attr( $logo_img_retina_src ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" /></a>
