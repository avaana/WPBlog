<article id="post-<?php the_ID(); ?>" <?php post_class( 'blog-post' ); ?>>
	...
	<?php if ( has_post_thumbnail() ) : ?>
		...
		<?php
			$gallery_images_arr = heart_and_style_get_post_meta( get_the_ID(), 'gallery_images' );
		?>

		<?php if ( shortcode_exists('heart_and_style_gallery') && $gallery_images_arr && count( $gallery_images_arr ) > 1 ) : ?>

			<?php echo do_shortcode( '[heart_and_style_gallery]' ); ?>
		...
		<?php else : ?>
			...
			<div class="blog-post-thumb">
				<?php
					...
					$res_img = heart_and_style_aq_resize( $thumb_url, 1084, 9999 );
