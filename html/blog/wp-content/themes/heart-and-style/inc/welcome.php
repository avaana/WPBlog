 ...
 * Activation Hook
 */
function heart_and_style_on_activation() {
	set_transient( '_heart_and_style_activation_redirect_1', true, 60 );
} add_action( 'after_switch_theme', 'heart_and_style_on_activation' );

/**
 * Process activation
 */
function heart_and_style_process_activation( $data = array() ) {
...
/**
 * Heart_And_Style_Welcome Class
 *
 * @since 1.0
 */
class Heart_And_Style_Welcome {
	...
	public function admin_menus() {
		...
		add_theme_page(
			esc_html__( 'Getting started with Heart and Style', 'heart-and-style' ),
			esc_html__( 'Theme Welcome', 'heart-and-style' ),
			$this->minimum_capability,
			'heart-and-style-getting-started',
	...
	public function tabs() {
		...
		$selected = isset( $_GET['page'] ) ? $_GET['page'] : 'heart-and-style-about';
		?>
		<h2 class="nav-tab-wrapper">
			<a class="nav-tab <?php echo $selected == 'heart-and-style-getting-started' ? 'nav-tab-active' : ''; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'heart-and-style-getting-started' ), 'themes.php' ) ) ); ?>">
				<?php esc_html_e( 'Welcome', 'heart-and-style' ); ?>
			</a>
		</h2>
		<?php
	...
	public function getting_started_screen() {
		...
		<div class="wrap about-wrap mt-welcome">
			...
			<h1><?php printf( esc_html__( 'Welcome to Heart and Style %s', 'heart-and-style' ), HEART_AND_STYLE_VER ); ?></h1>

			<div class="about-text"><?php esc_html_e( 'Thank you for using Heart and Style! We hope you will enjoy it and build awesome stuff with it.', 'heart-and-style' ); ?></div>

			<?php $this->tabs(); ?>

			<div class="changelog">

				<h3><?php esc_html_e( 'Theme Updates', 'heart-and-style' );?></h3>
			...
			<div class="changelog">
				...
				<h3><?php esc_html_e( 'Documentation', 'heart-and-style' );?></h3>

				<div class="feature-section">

					<p>The documentation can be found in the package you downloaded from Themeforest, in the directory called Documentation. But it is also available online, you can access it at <a target="_blank" href="http://meridianthemes.net/docs/heart-and-style/index.html" taget="_blank">meridianthemes.net/docs/heart-and-style</a></p>

				</div><!-- .feature-section -->

				<h3><?php esc_html_e( 'Support', 'heart-and-style' );?></h3>
				...
				<h3><?php esc_html_e( 'Changelog', 'heart-and-style' );?></h3>

				<div class="feature-section">

					<p>More information about the changes in the different versions of the theme can be found at <a target="_blank" href="https://meridianthemes.ticksy.com/articles/100001312">meridianthemes.ticky.com/articles</a></p>
	...
	public function welcome() {
		...
		if ( ! get_transient( '_heart_and_style_activation_redirect_1' ) )
			return;

		// Delete the redirect transient
		delete_transient( '_heart_and_style_activation_redirect_1' );

		// Bail if activating from network, or bulk
		if ( is_network_admin() || isset( $_GET['activate-multi'] ) )
			return;

		wp_safe_redirect( admin_url( 'themes.php?page=heart-and-style-getting-started' ) ); exit;

	}

}

new Heart_And_Style_Welcome();
